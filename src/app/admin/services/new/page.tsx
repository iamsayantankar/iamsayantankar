  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-6">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">New Service</h2>
      </div>
      <form onSubmit={handleSubmit} className="max-w-3xl space-y-5">
        ...
        <div className="flex gap-3 pt-2">
          <button type="submit" disabled={loading} className="px-6 py-2.5 rounded-lg bg-primary-600 text-white text-sm font-medium hover:bg-primary-700 transition-colors disabled:opacity-50">{loading ? "Creating..." : "Create Service"}</button>
