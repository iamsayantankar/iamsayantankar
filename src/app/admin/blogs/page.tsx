  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-5 sm:mb-6">
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">Blog Posts</h2>
        <div className="flex gap-2 sm:gap-3 items-center">
          ...
          <Link href="/admin/blogs/new" className="flex items-center gap-2 px-3 sm:px-4 py-2 rounded-lg bg-primary-600 text-white text-sm font-medium hover:bg-primary-700 transition-colors shrink-0"><HiPlus className="w-4 h-4" /> <span>Add New</span></Link>
        </div>
      </div>
